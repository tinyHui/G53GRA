...
an integer identifier for the associated texture object in graphics memory.
Do not change this file, you do not need to understand this file as it is beyond the scope of this module.
However just know that from inside a Object you can call Scene::GetTexture("myfilename.bmp") to load a texture.
*/
