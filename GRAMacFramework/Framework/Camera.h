...
/*
This is the camera class, it is used by the scene to controll the position and projection of the camera. You may change the implementation of the functions defined here, or add new ones if necessary, to create a camera that works in a more suitable way than the standard default camera.
*/
...
private:
    ...
    int wKey, sKey, aKey, dKey, eKey, qKey;
